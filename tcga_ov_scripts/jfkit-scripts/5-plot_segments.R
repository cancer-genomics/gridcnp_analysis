...
segDir <- "/dcl01/scharpf1/data/gridcnp_analysis/tcga_ov/jfkit/tumor_segments"
seg.files <- list.files(segDir)
### Choose sample
seg.file <- seg.files[i]

### Now same for bins
binDir <- "/dcl01/scharpf1/data/gridcnp_analysis/tcga_ov/jfkit/cases"
...
plot.dir <- "../../visualizations/tcga_ov_segments"
